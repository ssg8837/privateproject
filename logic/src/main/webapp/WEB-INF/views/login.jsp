	...
	<body> 
		...
		<form class="form-horizontal" action="login" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control  key_up" style="width:80%" id="userid" name="userid" placeholder="ID">
				</div>
			</div>
 			<div class="form-group">
				<label for="userpwd" class="col-sm-2 control-label">비밀번호</label>
				<div class="col-sm-10">
	      			<input type="password" class="form-control  key_up" style="width:80%" id="userpwd" name="userpwd" placeholder="Password">
	    		</div>
  			</div>
